...
async def type_construction_all(db:Session = Depends(get_db)):
...
async def type_construction_filter(id:int,db:Session = Depends(get_db)):
...
async def type_construction_create(type_constructio:type_construction_schema.TypeConstructionSchema,db:Session = Depends(get_db)):
...
async def type_construction_delete(id:int,db:Session = Depends(get_db)):
...
async def type_construction_update(id:int,type_constructio:type_construction_schema.TypeConstructionSchema,db:Session = Depends(get_db)):
