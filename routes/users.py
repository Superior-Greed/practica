...
@user_route.get("/{id_user}/{id_role}")
async def user_add_rolle(id_user:int,id_role:int,db:Session = Depends(get_db)):
    return _role_service.add_role_user(db,id_role,id_user)
